...
<header class="header">
    <div class="container text-center text-white spaces ">
        <div class="mt-3 space">  
            <a href="/clients" class="btn btn-dlink text-dark rounded-pill">
               <i>Clients</i>   <i class="far fa-address-book"></i>
            </a>    
        </div>
        <div class="mt-3 space">  
            <a href="/rma" class="btn btn-dlink text-dark rounded-pill">
               <i>RMA Base</i>   <i class="fas fa-database"></i>
            </a>    
        </div>
        <div class="mt-3 space">  
            <a href="/" class="btn btn-dlink text-dark rounded-pill">
    ...
    <div class="space-top text-center text-white pb-5">  
        <a href="/dashboard" class="btn btn-dlink mr-5 text-dark rounded-pill">
            <i><b>Admin</b></i>  <i class="fas fa-user-cog"></i>
        </a>  
        <a href="/logout" class="btn btn-dlink ml-5 text-dark rounded-pill">
